...
接口文档：docs/API_SPEC.md（含字段说明、示例与落地规范）
JSON Schema：schema/demo-data.schema.json，schema/annotation-range.schema.json
...
- 输入区支持折叠的“从 JSON 导入/导出”面板，可直接粘贴接口文档中的示例数据渲染
